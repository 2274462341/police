...
import { Collapse, List, Carousel, Input, DatePicker, Menu, Select, Radio, Pagination, Row, Col, Icon } from 'antd';
...
class Control extends Component {
                                    ...
                                    <Row className={styles.row}>
                                        <Col span={1} className={styles.col}>
                                            ...
                                            <div className={styles.button} onClick={this.change}>
                                                <span data-value="已关注"><Icon type="eye" className={styles.icon} />已关注</span>
                                            </div>
                                        </Col>
                                        <Col span={1} className={styles.col}>
                                            <a className={styles.h3}>{item.title}</a>
    ...
    change(event) {
        ...
        if (value === "已关注") {
            ...
            return (
                <span data-value="未关注">
                    <Icon type="eye-invisible" className={styles.icon} />
                    已关注
                </span>
            )
        }
